        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Edit Brand: {{$brands->brand_name}}</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{route('home.admins',$name)}}">Home</a></li>
                                <li class="breadcrumb-item"><a href="{{route('brands.list',$name)}}">Brands</a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <form action="{{ route('brands.update', [$brands->id,$name])}}" method="POST" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="brand_name" placeholder="Input field"
