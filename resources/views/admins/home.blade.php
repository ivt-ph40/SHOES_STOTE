        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="{{route('home.admins',$name)}}" class="nav-link">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="info-box mb-3">
                                ...
                                <div class="info-box-content">
                                    <a href="{{route('order.list',$name)}}"><span class="info-box-text">ORDER</span></a>
                                        ...
                                        <table class="table m-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="badge badge-success">{{$product->brand_name}}</span></td>
