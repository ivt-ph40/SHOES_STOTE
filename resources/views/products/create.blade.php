        ...
        <div class="content-wrapper">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('products.list',$name)}}">PRODUCT
                                    </a>
                                </li>
                            </ol>
                        </div>
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <form method="post" action="{{route('products.store',$name)}}">
                                @csrf
                                <div class="form-group">
                                    ...
                                    <select name="category_name">
                                        ...
                                        <option name="category_name" value="{{$category->category_name}}">
                                    ...
                                    <select name="brand_id">
                                        ...
                                        <option name="brand_id" value="{{$brand->id}}">{{$brand->brand_name}}
                                        </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <p class="help is-danger" style="color:red;font-size:20px">
                                    {{ $errors->first('product_code') }}</p>
                                @endif
                                <input type="text" name="category_id" value="0" class="form-control" placeholder=""
